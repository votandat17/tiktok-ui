                ...
                >
                    <div className={cx('search')}>
                        <button className={cx('search-icon')} onClick={visible ? Hide : Show}>
                            <FontAwesomeIcon style={{}} icon={faSearch} />
                        </button>
                        <button className={cx('search-btn')} onClick={visible ? Hide : Show}>
                            Search
                        </button>
                    </div>
                </Tippy>
